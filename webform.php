...
$debug = FALSE;
//Campaign setup
$campaignDefaultPhone = '18004509176'; //catch-all
$campaignHighLTVPhone = '18003379308';
$campaignLowLTVPhone = '18003870854';
$campaignTranche1Phone = '18005791987';
$campaignTranche2Phone = '18008530214';
$campaignTranche3Phone = '18008288966';
$campaignTranche4Phone = '18004990370';
...
$leadUpdate = 'http://dialer01.livecallconnect.com/non_agent_api.php';
$voicePost = 'http://dialer01.livecallconnect.com/agc/api.php';
...
if (isset ($_GET['firstmortgage_balance'])) {
	...
	if ($mortgage >= 625500) {
		...
		$mortgage_tranche=3;
	}elseif ($mortgage >= 125001) {
		$mortgage_tranche=4;
	}elseif ($mortgage <= 125000) {
		$mortgage_tranche = 99;
	}
} else {
	$mortgage = 125001;
